...
class CustomUser(AbstractUser):
    ...
    user_type = models.CharField(
        max_length=10, choices=USER_TYPE_CHOICES, default='survivor')
...
class SurvivorProfile(models.Model):
    ...
    user = models.OneToOneField(
        CustomUser, on_delete=models.CASCADE, related_name='survivor_profile')
...
class CounselorProfile(models.Model):
    ...
    """
    user = models.OneToOneField(
        CustomUser, on_delete=models.CASCADE, related_name='counselor_profile')
...
class Counselor(models.Model):
    ...
    expertise_sector = models.CharField(max_length=255)  # New field
